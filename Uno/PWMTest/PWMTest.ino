...
#define BASE_FREQ  82;          // 80 is on the spot for many flowers. Feel free to play with this +/-5Hz   //Set to 79.8 so that light banding is not too serious while videoing with shutter speed at 1/80 sec when light strobes at 80Hz
